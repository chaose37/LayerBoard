				 ...
				 <form class="form-horizontal form-label-left" novalidate
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="title" name="title" placeholder="title" value="${board.title }" required="required" type="text" class="form-control col-md-7 col-xs-12"> 
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="writer" name="writer" placeholder="writer" value="${board.writer }" required="required" type="text" class="form-control col-md-7 col-xs-12"> 
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    	  <textarea id="content" required="required"  name="content" class="form-control col-md-7 col-xs-12" rows=12>${board.content}</textarea>
                        </div>
