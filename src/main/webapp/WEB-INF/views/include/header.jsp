...
<html>
  <head>
    <meta charset="UTF-8">
    <title>내사전에롤백은없조 | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="${pageContext.request.contextPath}/resources/index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Rollback</b> PROJECT</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">롤백은없습니다</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    ...
                    <p>
                      	롤백은없습니다 - Web Developer
                      <small>-가입일이 들어가네요-</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="${pageContext.request.contextPath}/board/list"><i class="fa fa-circle-o"></i>게시판 v1</a></li>
                <li><a href="${pageContext.request.contextPath}/board2/list"><i class="fa fa-circle-o"></i>게시판 v2</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
